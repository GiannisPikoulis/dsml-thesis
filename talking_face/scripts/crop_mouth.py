...
if __name__ == "__main__":
    ...
    for idx, (subj, emotion, lvl, nbr) in enumerate(info):
        ...
        a = cut_mouth(generated_frames[idx], l_list)
        a = resize_images(a, (RESOLUTION, RESOLUTION))
        
        # Save each mouth crops as videos
        os.makedirs(f'samples/mouth_crops/align={ALIGN}_config={CONFIG}_ckpt={CKPT}', exist_ok=True)
        out_path = f"samples/mouth_crops/align={ALIGN}_config={CONFIG}_ckpt={CKPT}/subj={subj}_emo={emotion}_lvl={lvl}_nbr={nbr}.mp4"
